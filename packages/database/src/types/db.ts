  ...
  public: {
    Tables: {
      ...
      characters: {
        ...
        Relationships: [
          {
            foreignKeyName: "characters_global_character_id_fkey";
            columns: ["global_character_id"];
            isOneToOne: false;
            referencedRelation: "global_characters";
            referencedColumns: ["id"];
          },
        ];
      };
      ...
      experience_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "experience_log_global_character_id_fkey";
            columns: ["global_character_id"];
            isOneToOne: false;
            referencedRelation: "global_characters";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      character_vocation: "paladin" | "knight" | "sorcerer" | "monk" | "druid" | "none";
